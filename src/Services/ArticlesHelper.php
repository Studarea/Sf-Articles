...
// - Créez une classe ArticlesHelper dans un dossier "Services" dans le dossier "src"
// - Placez votre tableau d'articles en propriété de cette classe et appelez, dans les controleurs, cette propriété pour récupérer vos articles
// - Créez dans cette classe ArticleHelper une méthode qui va récupérer les trois derniers articles,
//   et appelez, dans votre controleur qui gère la page d'accueil, cette méthode pour récupérer les trois derniers articles
// - L'idée est de regrouper dans une classe toute la logique reliée aux articles.
...
class ArticleHelper extends AbstractController

{
    /**
     * @Route("/helper/{id}", name="helper_page")
     *
     */
